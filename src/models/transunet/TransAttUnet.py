...
class UNet_Attention_Transformer_Multiscale(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True, output_attention:bool=False):
        ...
        '''空间注意力机制'''
        self.pam = PAM_Module(512, self.output_attention)
